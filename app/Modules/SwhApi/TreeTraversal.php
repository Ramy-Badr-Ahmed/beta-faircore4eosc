...
abstract class TreeTraversal
{
    ...
    {
        $revisionOrReleaseID  = TreeEdges::getRevOrRelFromSnp($snapshot->getSwhid(),
            isset($branchQueue)
    ...
    {
        $rootDirectoryID = TreeEdges::getRootDirFromRev($revisionID->getSwhid());
    ...
    public static function traverseFromRelToRev(string $releaseID): SwhCoreID | Throwable
    {
        do{
            ...
            $relID = TreeEdges::getRevOrRelFromRel($releaseID);
    ...
    {
        $revisions =  TreeEdges::getSnapshotEdges($snapshotID);
