...
abstract class TreeEdges
{
    ...
    {
        try{
            $responseRel = TreeHopping::getFullRelease($releaseID);
    ...
    {
        try {
            $responseRev = TreeHopping::getFullRevision($revisionID);
    ...
    {
        $fullSnapshot = TreeHopping::getFullSnapshot($snapshotID, ...$flags);
    ...
    public static function getRevisionEdges(string $revisionID, ...$flags): Iterable|Collection|stdClass|Throwable
    {
        ...
        $fullRevision = TreeHopping::getFullRevision($revisionID, ...$flags);
    ...
    {
        $fullRelease = TreeHopping::getFullRelease($releaseID, ...$flags);
    ...
    {
        $allDirectory = TreeHopping::getFullDirectory($directoryID, ...$flags);
