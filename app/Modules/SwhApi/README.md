## LZI - SWH API Client (Documentation: in preparation)
...
- Check if the instantiated node is a SWH-node, i.e. `SWHID` given on `TreeNode` exists as SoftWare Heritage persistent IDentifier.
...
```php
> TreeTraversal::getFullNodeFromRev('badb581c17240cc57f6efe5edbe9ffe06f8e724e', 'source/Landau/LandauTutorial.ipynb')     
= [
    "type" => "file",
    ⋮
 ]
...
```php
> TreeTraversal::traverseFromRelToRev('swh:1:rel:73c638e86af20a4d3ef1d2eb2be5892a841b233f')

= App\Modules\SwhApi\SwhCoreID {#6499                            
    +"rev": "swh:1:rev:699640f64a89eb90b470a9d536efbb1ace5cc9ec",
  } 
```
...
> $dirID = TreeEdges::getRootDirFromRev(TreeEdges::getRevOrRelFromSnp($latestSnpID)->getSwhid())->getSwhid()
...
> $archiveObject->getSnpFromSaveRequest(823189)
    ...
    // SWHCoreID dataType (object form)  
= App\Modules\SwhApi\SwhCoreID {#6531
    +"snp": "swh:1:snp:a941df442c25529a69f927d61b5df21a5c1f7714",
  }
        // string format       
...
- Generate all tree root nodes (`snapshots`) keyed by the corresponding archival timestamp (`save_request_date`).
...
> Archive::of('https://github.com/nodejs/node')->getSnpFromSaveRequestID(22971)
    ...
    // SWHCoreID dataType (object form)
= App\Modules\SwhApi\SwhCoreID {#8154
