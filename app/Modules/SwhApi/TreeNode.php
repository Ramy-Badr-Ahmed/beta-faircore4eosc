...
class TreeNode extends SyncHTTP implements SwhNodes
{
    ...
    public function nodeTraversal(string|array $target = null): SwhCoreID|stdClass|Throwable
    {
        ...
        return match ($this->nodeInitials){
            'snp', 'rev', 'dir' => TreeTraversal::$traverseMethod($this->nodeInitials === 'snp' ? $this->nodeDataType : $this->nodeID, $target),
            'rel' => TreeTraversal::traverseFromRelToRev($this->nodeID)
        };
    }
