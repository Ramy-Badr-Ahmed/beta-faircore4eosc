...
<x-beta.navigation-bar :isArchiveActive="true"
                       :mtime="(new DateTime('Europe/Berlin'))->setTimeStamp(File::lastModified(base_path('resources/views/pages/beta/tree-view.blade.php')))->format('d/M/y @H:i')"/>

@section('headline', 'Software Heritage API Archival Requests')

@section('subtitle') <h4 style="letter-spacing: 1px">Tree View</h4> @endsection
        ...
        <div class="centered-content" style="margin-top: 10px">
            <div style="text-align: center">
                <p style="margin-bottom: 20px">
                    You can Deposit/Archive anew here. Useful for comparing SWH Core IDs.
                </p>
                <p style="margin-bottom: 20px">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <div class="text-center">
                    <button type="submit" id ="sub-btn" class="btn btn-primary -btn -btn-effect-deposit">Archive now</button>
                </div>
                ...
                initialize: function() {
                    ajaxTabulator.table = new Tabulator('#ajax-tabulator', {
                        ...
                        columns: [
                            ...
                            { title: 'SWH-IDs', field: 'swhid', headerHozAlign:'center', formatter: 'html', minWidth: 440, frozen:true,
